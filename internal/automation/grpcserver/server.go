...
func metricsToProto(metrics session.MetricsSnapshot) *automationpb.MetricsSnapshot {
	return &automationpb.MetricsSnapshot{
		...
		TransferQueueUploadsWindowTotal: metrics.TransferQueueUploadsWindowTotal,
		TransferUploadPath:              metrics.TransferUploadPath,
		ChunkStorageStrategy:            metrics.ChunkStorageStrategy,
		TraversalAlgorithm:              metrics.TraversalAlgorithm,
	}
}
